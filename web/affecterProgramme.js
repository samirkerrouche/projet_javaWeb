...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("lstClients").addEventListener("change", adaptProgram);
    displayProfiles();
    displayProgrammes();
...
/***
 * Tri les programmes selon le profil du client 
 * Renvoi Ensuite les programmes qui n y repondent pas directement.
 * @returns {undefined}
 */
function adaptProgram() {
    ...
    xhr.open("GET", "ServletVoirPrgm?nomCli=" + nomCli);
    xhr.onload = function () {
        if (xhr.status === 200) {
