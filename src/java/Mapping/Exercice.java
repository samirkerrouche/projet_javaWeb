 ...
 */
public class Exercice implements java.io.Serializable, Cloneable {
    ...
    public Exercice(String nomexo, String imageexo, String descriptionexo, Set composerSeances, Set executerExos, Set composerCircuits) {
        this.nomexo = nomexo;
    ...
    public String getImageexo() {
        return this.imageexo;
    }

    public void setImageexo(String imageexo) {
        this.imageexo = imageexo;
    }
